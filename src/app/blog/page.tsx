          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-end">
            <div>
              ...
              <h1 className="mt-5 max-w-5xl text-[clamp(3rem,7vw,6.2rem)] leading-[0.95] tracking-[-0.055em] text-[#171311]">
                Product notes, compliance thinking, and operating lessons from the work.
              </h1>
            </div>
            <p className="max-w-xl text-[1rem] leading-7 text-[#64584f]">
              You asked for a blog with the same editorial energy as the reference. This version leans into large type, cleaner image blocks, and roomier pacing so the journal feels like part of the brand.
            </p>
          </div>
